...
#define UNICAST_ACK_CMD_DATA_MAX  	    MODEM_DATA_MAX
...
// Test
#define TEST_CMD_LOCAL_RESP_ADDR_MAX    3
#define TEST_CMD_LOCAL_RESP_MAX         TEST_CMD_LOCAL_RESP_ADDR_MAX
...
// Voltage and Noise Measurement
#define VOLT_NOISE_MSR_CMD_LOCAL_RESP_MAX     3
...
#define QUERY_STATUS_RESP_VOLT_DATA_MAX     5
#define QUERY_STATUS_RESP_VOLT_MAX          QUERY_STATUS_RESP_FIELD_PRE_MAX + \
                                            QUERY_STATUS_RESP_VOLT_DATA_MAX
#define QUERY_STATUS_RESP_REL_DATA_MAX      11
#define QUERY_STATUS_RESP_REL_MAX           QUERY_STATUS_RESP_FIELD_PRE_MAX + \
                                            QUERY_STATUS_RESP_REL_DATA_MAX
#define QUERY_STATUS_RESP_BT_YEAR_DATA_MAX  10
#define QUERY_STATUS_RESP_BT_YEAR_MAX       QUERY_STATUS_RESP_FIELD_PRE_MAX + \
                                            QUERY_STATUS_RESP_BT_YEAR_DATA_MAX
#define QUERY_STATUS_RESP_BT_TIME_DATA_MAX  9
...
#define CHN_IMP_RESP_RANGE_DATA_MAX   5
#define CHN_IMP_RESP_RANGE_MAX        CHN_IMP_RESP_FIELD_PRE_MAX + \
                                      CHN_IMP_RESP_RANGE_DATA_MAX
#define CHN_IMP_RESP_SAMP_AMT_DATA_MAX 5
#define CHN_IMP_RESP_SAMP_AMT_MAX     CHN_IMP_RESP_FIELD_PRE_MAX + \
                                      CHN_IMP_RESP_SAMP_AMT_DATA_MAX
...
#define NOISE_MSR_RESP_RMS_DATA_MAX   6
#define NOISE_MSR_RESP_RMS_MAX        NOISE_MSR_RESP_FIELD_PRE_MAX + \
                                      NOISE_MSR_RESP_RMS_DATA_MAX
#define NOISE_MSR_RESP_P2P_DATA_MAX   6
#define NOISE_MSR_RESP_P2P_MAX        NOISE_MSR_RESP_FIELD_PRE_MAX + \
                                      NOISE_MSR_RESP_P2P_DATA_MAX
#define NOISE_MSR_RESP_MAG_DATA_MAX   6
#define NOISE_MSR_RESP_MAG_MAX        NOISE_MSR_RESP_FIELD_PRE_MAX + \
                                      NOISE_MSR_RESP_MAG_DATA_MAX
...
#define RANGE_RESP_DATA_MAX       5
#define RANGE_RESP_RANGE_MAX      RANGE_RESP_FIELD_PRE_MAX + \
                                  RANGE_RESP_RANGE_DATA_MAX
#define RANGE_RESP_MAX            RANGE_RESP_HDR_MAX + \
                                  RANGE_RESP_RANGE_MAX

// Spectrum Measurement
#define SPEC_MSR_RESP_NUM_BINS_DATA_MAX 5
#define SPEC_MSR_RESP_MAG_DATA_MAX      sizeof(unint16_t)
...
#define VOLT_NOISE_MSR_RESP_VOLT_DATA_MAX   5
#define VOLT_NOISE_MSR_RESP_VOLT_MAX        VOLT_NOISE_MSR_RESP_FIELD_PRE_MAX + \
                                            VOLT_NOISE_MSR_RESP_VOLT_DATA_MAX
